...
# Las funciones increment_token_usage e increment_token_usage_raw han sido eliminadas
# en favor del sistema unificado de tracking en common/tracking/_base.py
# Use common.tracking.track_token_usage() que incluye soporte para idempotencia
# y tipos estandarizados.
