...
async def check_embedding_service_status() -> str:
    ...
    Soporta verificación de proveedores OpenAI y Groq.
    ...
    try:
        ...
        # Verificamos solo proveedores soportados: OpenAI para embeddings y Groq para LLMs
        
        # Si Groq o OpenAI están degradados pero no indisponibles, reportar como degradado
